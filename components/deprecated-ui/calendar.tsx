...
function getTheme(
  ...
  if (isThemeDark) {
    return {
      ...
      calendarBackground: NAV_THEME.dark.colors.card,
      textSectionTitleColor: NAV_THEME.dark.colors.text,
      selectedDayBackgroundColor: NAV_THEME.dark.colors.primary,
      selectedDayTextColor: '#000000',
      todayTextColor: SKY_500,
      dayTextColor: NAV_THEME.dark.colors.text,
      textDisabledColor: '#ffffff30',
      monthTextColor: NAV_THEME.dark.colors.text,
      textMonthFontWeight: '500',
      arrowColor: NAV_THEME.dark.colors.primary,
      ...customTheme,
    };
  }
  return {
    backgroundColor: NAV_THEME.light.colors.background,
    calendarBackground: NAV_THEME.light.colors.card,
    textSectionTitleColor: NAV_THEME.light.colors.text,
    selectedDayBackgroundColor: SKY_600,
    selectedDayTextColor: '#ffffff',
    todayTextColor: SKY_600,
    dayTextColor: '#2d4150',
    monthTextColor: NAV_THEME.light.colors.text,
    textMonthFontWeight: '500',
    arrowColor: SKY_600,
    ...customTheme,
  };
